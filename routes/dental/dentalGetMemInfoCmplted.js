...
router.get('/', function(req, res, next) {
  ...
  Member.find({stat:2, name: req.query.name , mobile: req.query.mobile, dntl_key: req.session.dental._id},{createdAt:0,updatedAt:0}).populate('img_key').exec(function(err, docs){
